 ...
 * 7. 이 때는 반환유형을 선언시에 비워두면 안되고 반드시 void를 적어줘야
 *    합니다.
...
public class MethodExample3 {
	...
	if(name.length()<2) { //length():문자열의 길이 메서드
		System.out.println("이름은 2글자 이상으로 입력하세요!");
		return; //함수를 강제 종료시켜라 while의 break 기능. if가 조건문을 만나서 return을 만나면 그 아래 코드가 실행이 되지 않는다.
	}
